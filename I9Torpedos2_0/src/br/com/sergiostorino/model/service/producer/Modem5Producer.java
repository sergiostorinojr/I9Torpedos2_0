 ...
 * @author Junior
 */
public class Modem5Producer implements Runnable {

    private Queue<SMSSendMessage> fila;
    private static final Log log = LogFactory.getLog(Modem5Producer.class);
    ...
    public Modem5Producer(Queue<SMSSendMessage> fila) {
        ...
        try {
            ...
            Logger.getLogger(Modem5Producer.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void run() {
        ...
        while (!getFila().isEmpty()) {
            ...
            try {
                ...
                new ControllerSendSIM<SendSIM5>(SendSIM5.class).save((SendSIM5) saveSendSMS);
