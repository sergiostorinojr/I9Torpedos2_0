 ...
 * @author Junior
 */
public class SerialModemThreeGateway implements Modem {
    ...
    public SerialModemThreeGateway() {
        ...
        try {
            ...
            Logger.getLogger(SerialModemThreeGateway.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public SerialModemGateway getGatewayConfig() {
        ...
        if (this.gateway == null) {
            ...
            this.gateway = new SerialModemGateway(
                    this.props.getProperty("sms3.service.modem"),
                    this.props.getProperty("sms3.service.porta"),
                    Integer.parseInt(this.props.getProperty("sms3.service.taxaTransmissao")),
                    this.props.getProperty("sms3.service.fabricante"),
                    this.props.getProperty("sms3.service.modelo"));
            this.gateway.setInbound(Boolean.parseBoolean(this.props.getProperty("sms3.service.inbound")));
            this.gateway.setOutbound(Boolean.parseBoolean(this.props.getProperty("sms3.service.outbound")));
            this.gateway.setSimPin(this.props.getProperty("sms3.service.pin1"));
            this.gateway.setSimPin2(this.props.getProperty("sms3.service.pin2"));
