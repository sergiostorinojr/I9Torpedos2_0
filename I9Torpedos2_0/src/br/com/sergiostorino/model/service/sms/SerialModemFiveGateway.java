 ...
 * @author Junior
 */
public class SerialModemFiveGateway implements Modem {
    ...
    public SerialModemFiveGateway() {
        ...
        try {
            ...
            Logger.getLogger(SerialModemFiveGateway.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public SerialModemGateway getGatewayConfig() {
        ...
        if (this.gateway == null) {
            ...
            this.gateway = new SerialModemGateway(
                    this.props.getProperty("sms5.service.modem"),
                    this.props.getProperty("sms5.service.porta"),
                    Integer.parseInt(this.props.getProperty("sms5.service.taxaTransmissao")),
                    this.props.getProperty("sms5.service.fabricante"),
                    this.props.getProperty("sms5.service.modelo"));
            this.gateway.setInbound(Boolean.parseBoolean(this.props.getProperty("sms5.service.inbound")));
            this.gateway.setOutbound(Boolean.parseBoolean(this.props.getProperty("sms5.service.outbound")));
            this.gateway.setSimPin(this.props.getProperty("sms5.service.pin1"));
            this.gateway.setSimPin2(this.props.getProperty("sms5.service.pin2"));
