 ...
 * @author Junior
 */
public class SerialModemFourGateway implements Modem {
    ...
    public SerialModemFourGateway() {
        ...
        try {
            ...
            Logger.getLogger(SerialModemFourGateway.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public SerialModemGateway getGatewayConfig() {
        ...
        if (this.gateway == null) {
            ...
            this.gateway = new SerialModemGateway(
                    this.props.getProperty("sms4.service.modem"),
                    this.props.getProperty("sms4.service.porta"),
                    Integer.parseInt(this.props.getProperty("sms4.service.taxaTransmissao")),
                    this.props.getProperty("sms4.service.fabricante"),
                    this.props.getProperty("sms4.service.modelo"));
            this.gateway.setInbound(Boolean.parseBoolean(this.props.getProperty("sms4.service.inbound")));
            this.gateway.setOutbound(Boolean.parseBoolean(this.props.getProperty("sms4.service.outbound")));
            this.gateway.setSimPin(this.props.getProperty("sms4.service.pin1"));
            this.gateway.setSimPin2(this.props.getProperty("sms4.service.pin2"));
