 ...
 * @param <T>
 */
public class ControllerReceivedSIM<T> implements ControllerRepository<T> {

    private Class<?> clazz;

    public ControllerReceivedSIM(Class<?> clazz) {
        this.clazz = clazz;
    }
    ...
    public T findById(Long id) {
        ...
        try {
            ...
            Logger.getLogger(ControllerReceivedSIM.class.getName()).log(Level.SEVERE, null, ex);
        }
        return findById;
    }
