 ...
 * @param <T>
 */
public class ControllerSendSIM<T> implements ControllerRepository<T> {

    private Class<?> clazz;

    public ControllerSendSIM(Class<?> clazz) {
        this.clazz = clazz;
    }
    ...
    public T findById(Long id) {
        ...
        try {
            ...
            Logger.getLogger(ControllerSendSIM.class.getName()).log(Level.SEVERE, null, ex);
        }
        return findById;
    }
